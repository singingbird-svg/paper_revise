...
framework ($\mathrm{D}^{2}\mathrm{TAPR}$). Its semi-distributed nature arises from leader-based coordination during collaborative subtasks. The global task specified in linear temporal logic
